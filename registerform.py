...
class Test:
    def __init__(self):
        ...
        self.firstname = Tkinter.StringVar(self.root)
        self.lastname=Tkinter.StringVar(self.root)
    ...
    def setupGUI(self):
        ...
        ref3=Tkinter.Button(self.root,text="Edit",width=10,font=("arial", 10, "bold"),
                              command=self.edit)
        ref3.grid(row=10,column=2)
    ...
    def edit(self):
     ...
     if(self.connection):
        ...
        edit = """update registerform set firstname='%s',lastname='%s',email='%s',dob='%s',phone='%s',gender='%s',address='%s',country='%s',state='%s',city='%s';""" % (
        self.firstname, self.lastname, self.email, self.dob, self.phone, self.gender, self.address, self.country,
